...
module dnn_accel_system_mm_interconnect_0 (
	...
	wire  [101:0] cmd_mux_003_src_data;                                                               // cmd_mux_003:src_data -> pio_0_s1_agent:cp_data
	...
	wire   [83:0] new_sdram_controller_0_s1_agent_rp_data;                                            // new_sdram_controller_0_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [101:0] pio_0_s1_agent_rp_data;                                                             // pio_0_s1_agent:rp_data -> router_005:sink_data
	...
	wire   [83:0] router_004_src_data;                                                                // router_004:src_data -> new_sdram_controller_0_s1_rsp_width_adapter:in_data
	wire          router_004_src_ready;                                                               // new_sdram_controller_0_s1_rsp_width_adapter:in_ready -> router_004:src_ready
	wire    [3:0] router_004_src_channel;                                                             // router_004:src_channel -> new_sdram_controller_0_s1_rsp_width_adapter:in_channel
	...
	wire  [101:0] new_sdram_controller_0_s1_rsp_width_adapter_src_data;                               // new_sdram_controller_0_s1_rsp_width_adapter:out_data -> rsp_demux_002:sink_data
	...
	wire    [3:0] new_sdram_controller_0_s1_rsp_width_adapter_src_channel;                            // new_sdram_controller_0_s1_rsp_width_adapter:out_channel -> rsp_demux_002:sink_channel
	...
	wire  [101:0] cmd_mux_002_src_data;                                                               // cmd_mux_002:src_data -> new_sdram_controller_0_s1_cmd_width_adapter:in_data
	wire          cmd_mux_002_src_ready;                                                              // new_sdram_controller_0_s1_cmd_width_adapter:in_ready -> cmd_mux_002:src_ready
	wire    [3:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> new_sdram_controller_0_s1_cmd_width_adapter:in_channel
	...
	dnn_accel_system_mm_interconnect_0_avalon_st_adapter_002 #(
		.inBitsPerSymbol (18),
		.inUsePackets    (0),
		.inDataWidth     (18),
		.inChannelWidth  (0),
